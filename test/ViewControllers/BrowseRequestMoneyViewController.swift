...
class BrowseRequestMoneyViewController: BaseViewController {

    @IBOutlet weak var request_message: EditText!
    ...
    @IBAction func submitPressed(_ sender: Any) {
        ...
        popupViewController.modalTransitionStyle = .crossDissolve
            ...
            popupViewController.request_message=request_message.text!
            ...
            popupViewController.selectedUser=UserModel()
            popupViewController.proposed_money=proposed_money
            popupViewController.loan_agreement += "<p><strong>SPOTME LOAN AGREEMENT</strong></p>\n <p>THIS LOAN AGREEMENT (the &ldquo;Agreement&rdquo;), is made and entered into by and between <u><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"(@"+"LENDER_USERNAME"+") "+"LENDER_NAME"+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></u> (hereinafter, known as &ldquo;Lender&rdquo;) and  <u><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"(@"+currentUser.username+") "+currentUser.name+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></u>, (hereinafter, known as &ldquo;Borrower&rdquo;). Both the Lender and the Borrower shall collectively be referred to herein as &ldquo;the Parties&rdquo;. This Agreement governs the process by which you may make a request or requests for a loan from other users of SpotMe through the website spotmeapp.us or the spotme app, including any subdomains thereof, or other application channels offered by us (collectively, the \"Site\"). If you make a loan request, and if that request results in a loan that is approved and funded by us, then your loan will be governed by the terms of the Loan Agreement.</p>\n<ol>\n"
