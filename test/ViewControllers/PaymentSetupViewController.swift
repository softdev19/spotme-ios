...
class PaymentSetupViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        getAccountLink(uid: Auth.auth().currentUser!.uid)
    ...
    func getAccountLink(uid:String)
    {
        showLoading()
        self.webview.isHidden=true
        let URL:String = "https://us-central1-spotme-39709.cloudfunctions.net/getAccountLinks"
